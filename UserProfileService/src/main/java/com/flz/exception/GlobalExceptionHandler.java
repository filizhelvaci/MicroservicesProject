...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> handleAuthException(UserProfileException e) {
        ErrType errorType = e.getType();
    ...
    public ResponseEntity<ErrorMessage> handleMethodArgumentNotValidException(MethodArgumentNotValidException ex) {
        ErrType errorType = ErrType.BAD_REQUEST;
    ...
    private ErrorMessage createErrorMesaj(ErrType errorType, Exception exception) {
    ...
    private ErrorMessage createError(ErrType errorType, Exception ex) {
    ...
    public final ResponseEntity<ErrorMessage> handleAllExceptions(Exception exception) {
        ErrType errorType = ErrType.INTERNAL_ERROR_SERVER;
        List<String> fields = new ArrayList<>();
